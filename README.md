...
│ └── img/
│ └── irina-profile.jpg # Imagen de perfil (Ejemplo)
├── views/
│ ├── layouts/
│ │ └── main.hbs # Layout principal (Base HTML y Sticky Footer)
│ ├── partials/
│ │ ├── footer.hbs # Pie de página (con helper y LN)
│ │ └── header.hbs # Barra de navegación
